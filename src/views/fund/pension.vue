<template>
  <div class="app-container">
      ...
      <el-row>
        <el-col :xs="12" :sm="12" :md="12" :lg="12">
          <div class="top_tip">
            ...
            <span style="color: #657180;">养老优选</span>
          </div>
        </el-col>
        <el-col :xs="12" :sm="12" :md="12" :lg="12">
        </el-col>
    ...
    <div class="border_div">
      <div class="tip_title">养老基金优选</div>

      <el-row>
        <div class="filter-container">
          <el-col :xs="7" :sm="7" :md="7" :lg="7">
            <span style="padding-left: 5px;padding-right: 5px;">年均收益率：</span>
          ...
          <el-col :xs="7" :sm="7" :md="7" :lg="7">
            <span style="padding-left: 5px;padding-right: 5px;">基金类型：</span>
            <el-select v-model="choose_type" @change="changeType" clearable placeholder="请选择" size="small">
              <el-option v-for="item in type_data" :key="item.value" :label="item.label" :value="item.value"></el-option>
            </el-select>
          </el-col>
          ...
          <span style="padding-left: 5px;padding-right: 5px;">是否优选
            <el-tooltip placement="top-end" effect="light">
              <div slot="content">优选规则: <br/>
                ...
                <span style="padding-left: 10px">2、基金成立三年以上</span><br/>
                <span style="padding-left: 10px">3、历史年化收益率大于4%</span><br/>
              </div>
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24">
          <div id="invest_choose_data">
            <el-table :data="tableData" @sort-change="sortableChange" style="width: 100%">
              ...
              <el-table-column prop="setup_date" width="120" sortable label="成立日期"></el-table-column>
              <el-table-column prop="income_rate_for_year" width="140" sortable label="年均收益率" align="center"></el-table-column>
              <el-table-column prop="purchase_rate" width="120" sortable label="申购费率" align="center"></el-table-column>
              <el-table-column prop="return_rate" width="120" sortable label="赎回费率" align="center"></el-table-column>
              <el-table-column prop="manager" width="140" sortable label="基金经理" align="center"></el-table-column>
    ...
    <el-dialog title="已关注基金" class="choice_fund" :visible.sync="dialogTableVisible">
      <div>
        <el-table :data="selectedData" style="width: 100%">
          <el-table-column prop="code" label="代码" sortable width="120" align="center">
            <template slot-scope="scope">
              <a :href="'/#/p/fund/' + scope.row.code" target="_blank">{{scope.row.code}}</a>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="setup_date" label="成立日期" sortable width="120"></el-table-column>
...
<script type="es6">
  import { getPensionData } from '@/api/fund';
  ...
  export default {
    ...
    methods: {
      getPensionData() {
        getPensionData(this.min_income_rate_for_year, this.choose_type, this.is_preferred, this.selected_code,
          ...
          for (let val of temp) {
            this.tableData.push({
              ...
              'income_rate_for_year': val['income_rate_for_year'],
